...
input_to_lstm = sequential_layers(input, [layer_sizes[0], 16], "fully_connected")
lstm = lstm(input_to_lstm, 16)
lstm_to_output = sequential_layers(input, [16, layer_sizes[-1]], "fully_connected")


output = output_activations(lstm_to_output, name='output_activation')
