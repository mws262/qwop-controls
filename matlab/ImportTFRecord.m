...
for k = 1:length(files)
    ...
    for i = 0:loadedFileData.size() - 1
        loadedStates = [loadedStates, dataParser.getStatesFromLoadedSequence(loadedFileData.get(i))];
        loadedCommands = [loadedCommands; dataParser.getCommandSequenceFromLoadedSequence(loadedFileData.get(i))];
    end
end
