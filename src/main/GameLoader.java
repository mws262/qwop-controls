...
public class GameLoader extends ClassLoader {
	...
	private void loadClasses() {
		...
		contactListenerProxy = Proxy.newProxyInstance(_ContactListener.getClassLoader(), new Class[] {_ContactListener}, 
			...
			public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
				...
				switch (method_name) {
				case "add":	
					fixtureABody = args[0].getClass().getField("shape1").get(null).getClass().getField("m_body").get(null);
					fixtureBBody = args[0].getClass().getField("shape2").get(null).getClass().getField("m_body").get(null);
	...
	private void makeNewWorld() throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchFieldException {
		...
		rFootBody.getClass().getMethod("createShape", _PolygonDef).invoke(rFootBody, rFootShape);
		lFootBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, lFootDef);
		lFootBody.getClass().getMethod("createShape", _PolygonDef).invoke(lFootBody, lFootShape);

		rCalfBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, rCalfDef);
		rCalfBody.getClass().getMethod("createShape", _PolygonDef).invoke(rCalfBody, rCalfShape);
		lCalfBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, lCalfDef);
		lCalfBody.getClass().getMethod("createShape", _PolygonDef).invoke(lCalfBody, lCalfShape);

		rThighBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, rThighDef);
		rThighBody.getClass().getMethod("createShape", _PolygonDef).invoke(rThighBody, rThighShape);
		lThighBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, lThighDef);
		lThighBody.getClass().getMethod("createShape", _PolygonDef).invoke(lThighBody, lThighShape);

		rUArmBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, rUArmDef);
		rUArmBody.getClass().getMethod("createShape", _PolygonDef).invoke(rUArmBody, rUArmShape);
		lUArmBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, lUArmDef);
		lUArmBody.getClass().getMethod("createShape", _PolygonDef).invoke(lUArmBody, lUArmShape);

		rLArmBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, rLArmDef);
		rLArmBody.getClass().getMethod("createShape", _PolygonDef).invoke(rLArmBody, rLArmShape);
		lLArmBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, lLArmDef);
		lLArmBody.getClass().getMethod("createShape", _PolygonDef).invoke(lLArmBody, lLArmShape);

		torsoBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, torsoDef);
		torsoBody.getClass().getMethod("createShape", _PolygonDef).invoke(torsoBody, torsoShape);

		headBody = world.getClass().getMethod("createBody", _BodyDef).invoke(world, headDef);
		headBody.getClass().getMethod("createShape", _PolygonDef).invoke(headBody, headShape);
		...
		world.getClass().getMethod("setContactListener", _ContactListener).invoke(null, contactListenerProxy.getClass().cast(_ContactListener));
