...
//
//    /**
//     * Creates a new value function and figures out which game.action need to be possibly classified by the value
...
//     * @param allPossibleActions ALl game.action which this value function will be aware of.
//     */
//    private ValueFunction_TensorFlow_ActionInMulti(Collection<Action> allPossibleActions) {
//
//        // Sort out all the game.action we'll potentially have to differentiate between.
...
//     * inputs/outputs is NOT checked and will cause issues later on if incorrect. Also, if extra game.action have been
...
//     * @param allPossibleActions All possible game.action that this value function should be able to differentiate between.
