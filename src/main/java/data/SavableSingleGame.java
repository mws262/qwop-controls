...
/**
 * Structure to hold game.actions and states in individual QWOP runs for saving to file. This holds data sparsely, meaning
...
public class SavableSingleGame implements Serializable {
     ...
     *
     * @param terminalNode End node of the run to be saved. All states and game.actions up to this point will be saved.
     */
