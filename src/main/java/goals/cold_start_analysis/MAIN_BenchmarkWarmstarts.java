...
//        GameThreadSafeSavable gameMulti = new GameThreadSafeSavable();
//
//
...
//        Utility.tic();
//        for (int i = 0; i < singleTestSamples; i++) {
//            multiSave = gameMulti.getFullState();
//        }
...
//        Utility.tic();
//        for (int i = 0; i < singleTestSamples; i++) {
//            gameMulti = gameMulti.getRestoredCopy(multiSave);
//        }
//        timeElapsed = Utility.toc();
...
//            gameMulti.step(actions.pollCommand());
//        }
//        byte[] fullStateMulti = gameMulti.getFullState();
//
//        Utility.tic();
//        for (int i = 0; i < samples; i++) {
//            gameMulti = gameMulti.getRestoredCopy(fullStateMulti);
//            gameMulti.step(true, false, false, true);
//        }
//        timeElapsed = Utility.toc();
//
...
//        Utility.tic();
//        for (int i = 0; i < samples; i++) {
//            fullStateMulti = gameMulti.getFullState();
//            gameMulti = gameMulti.getRestoredCopy(fullStateMulti);
//            gameMulti.step(true, false, false, true);
//        }
//        timeElapsed = Utility.toc();
