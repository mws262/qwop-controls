...
public class TestDeepRL implements MDP<StateRL, Integer, DiscreteSpace> {


    @Override
    public ObservationSpace<StateRL> getObservationSpace() {
        return null;
    }
    ...
    @Override
    public StepReply<StateRL> step(Integer integer) {
        return null;
    }
    ...
    @Override
    public MDP<StateRL, Integer, DiscreteSpace> newInstance() {
        return null;
    }
}
