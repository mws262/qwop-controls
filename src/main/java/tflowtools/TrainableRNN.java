 ...
 * @author matt
 */
public class TrainableRNN {

    /**
     * Networks are not created in Java. Java calls a python script defined here to create the network.
     */
    public static final String pythonGraphCreatorScript = "python/java_value_function/create_lstm.py";
     ...
     */
    private static Logger logger = LogManager.getLogger(TrainableRNN.class);
     ...
     */
    public TrainableRNN(File graphDefinition) throws FileNotFoundException {
...
//        output.copyTo(outputStuff);
     ...
     */
    public static TrainableRNN makeNewNetwork(String graphName, List<Integer> layerSizes,
        ...
        return new TrainableRNN(graphFile);
    }

    public static TrainableRNN makeNewNetwork(String graphName, List<Integer> layerSizes) throws FileNotFoundException {
