...
public abstract class RolloutPolicy {
     ...
     * @return
     */
    public abstract float rollout(Node startNode, GameLoader game);
     ...
     */
    void simGameToNode(Node targetNode, GameLoader game) {
     ...
     */
    void coldStartGameToNode(Node target, GameLoader game) {
        // Reset the game and action queue.
        game.makeNewWorld();
        actionQueue.clearAll();
     ...
     */
    Node randomRollout(Node startNode, GameLoader game) {
