...
/**
 * Perturbs {@link ActionQueue} by making some or all of the transitions between actions happen too early. Total
...
public class ActionPerturber_SwitchTooSoon implements IActionPerturber {
    ...
    /**
     * Make a new perturber by defining which actions should be changed and by how much.
     *
