...
//
//    private CommandQWOP chosenCommand;
//
//
//
...
//
//            chosenCommand[0] = keysWeighted[0] >= 0.5f;
//            chosenCommand[1] = keysWeighted[1] >= 0.5f;
//            chosenCommand[2] = keysWeighted[2] >= 0.5f;
//            chosenCommand[3] = keysWeighted[3] >= 0.5f;
//
//            if (!Arrays.equals(chosenCommand, bestEntry.getValue().keys)) {
//                logger.debug("Top match overridden by voting.");
//            }
//        } else {
//            chosenCommand = bestMatch.keys;
//        }
//
...
//                    chosenCommand = currentTrajectoryStateMatch.keys;
//                }
//            } else {
//                currentTrajectory = bestMatch.parentRun;
//                currentTrajectoryStateMatch = bestMatch;
...
//
//        Action currentAction = new Action(1, chosenCommand);
//
...
//     */
//    private static void loadAll(List<File> files) throws IOException {
//
//        Utility.tic();
//
