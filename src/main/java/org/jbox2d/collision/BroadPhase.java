...
public class BroadPhase implements Externalizable {
	...
	private Vec2 m_quantizationFactor;
	...
	boolean testOverlap(final Proxy p1, final Proxy p2) {
	...
	private static int binarySearch(final Bound[] bounds, final int count, final int value) {
		int low = 0;
		int high = count - 1;
		while ( low <= high) {
