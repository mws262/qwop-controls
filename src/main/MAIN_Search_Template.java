...
public abstract class MAIN_Search_Template {
	...
	private List<TreeWorker> activeWorkers = new ArrayList<TreeWorker>();
	...
	public MAIN_Search_Template() {
		...
		maxWorkers = (int)(workersFractionOfCores*cores); // Basing of number of cores including hyperthreading. May want to optimize this a tad.
		System.out.println("Detected " + cores + " physical cores. Making a max of " + maxWorkers + " workers.");

		workerPool = new GenericObjectPool<TreeWorker>(new WorkerFactory());
