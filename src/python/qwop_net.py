...
tfrecordPath = '/media/matt/Storage/QWOP_Tfrecord_1_20/'  # Location of datafiles on this machine.
...
layer2 = nn_layer(layer1, 36, 8, 'layer2')
layer3 = nn_layer(layer2, 8, 36, 'layer3')
layer4 = nn_layer(layer3, 36, 72, 'layer4')
