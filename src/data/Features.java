...
public  final class Features extends
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            com.google.protobuf.MapEntry<java.lang.String, data.Feature>
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return data.FeatureProtos.internal_static_tensorflow_Features_descriptor;
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return data.FeatureProtos.internal_static_tensorflow_Features_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            data.Features.class, data.Features.Builder.class);
  }

  public static final int FEATURE_FIELD_NUMBER = 1;
  private static final class FeatureDefaultEntryHolder {
    static final com.google.protobuf.MapEntry<
        java.lang.String, data.Feature> defaultEntry =
            com.google.protobuf.MapEntry
            .<java.lang.String, data.Feature>newDefaultInstance(
                data.FeatureProtos.internal_static_tensorflow_Features_FeatureEntry_descriptor, 
  ...
  private com.google.protobuf.MapField<
      java.lang.String, data.Feature> feature_;
  private com.google.protobuf.MapField<java.lang.String, data.Feature>
  internalGetFeature() {
    if (feature_ == null) {
  ...
  public java.util.Map<java.lang.String, data.Feature> getFeature() {
  ...
  public java.util.Map<java.lang.String, data.Feature> getFeatureMap() {
  ...
  public data.Feature getFeatureOrDefault(
      java.lang.String key,
      data.Feature defaultValue) {
    if (key == null) { throw new java.lang.NullPointerException(); }
    java.util.Map<java.lang.String, data.Feature> map =
  ...
  public data.Feature getFeatureOrThrow(
      java.lang.String key) {
    if (key == null) { throw new java.lang.NullPointerException(); }
    java.util.Map<java.lang.String, data.Feature> map =
        internalGetFeature().getMap();
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    for (java.util.Map.Entry<java.lang.String, data.Feature> entry
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof data.Features)) {
      return super.equals(obj);
    }
    data.Features other = (data.Features) obj;
  ...
  public static data.Features parseFrom(
  ...
  public static data.Features parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static data.Features parseFrom(
  ...
  public static data.Features parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static data.Features parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static data.Features parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(data.Features prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using data.Features.newBuilder()
    private Builder() {
    ...
    public data.Features getDefaultInstanceForType() {
      return data.Features.getDefaultInstance();
    }

    public data.Features build() {
      data.Features result = buildPartial();
    ...
    public data.Features buildPartial() {
      data.Features result = new data.Features(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof data.Features) {
        return mergeFrom((data.Features)other);
      } else {
    ...
    public Builder mergeFrom(data.Features other) {
      if (other == data.Features.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      data.Features parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (data.Features) e.getUnfinishedMessage();
     ...
     */
    @java.lang.Deprecated
    public java.util.Map<java.lang.String, data.Feature>
    getMutableFeature() {
    ...
    public Builder putAllFeature(
        java.util.Map<java.lang.String, data.Feature> values) {
  ...
  private static final data.Features DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new data.Features();
  }

  public static data.Features getDefaultInstance() {
