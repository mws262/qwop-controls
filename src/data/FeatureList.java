...
public  final class FeatureList extends
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
              feature_ = new java.util.ArrayList<data.Feature>();
              mutable_bitField0_ |= 0x00000001;
            }
            feature_.add(
                input.readMessage(data.Feature.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return data.FeatureProtos.internal_static_tensorflow_FeatureList_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return data.FeatureProtos.internal_static_tensorflow_FeatureList_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            data.FeatureList.class, data.FeatureList.Builder.class);
  }

  public static final int FEATURE_FIELD_NUMBER = 1;
  private java.util.List<data.Feature> feature_;
  /**
   * <code>repeated .tensorflow.Feature feature = 1;</code>
   */
  public java.util.List<data.Feature> getFeatureList() {
    return feature_;
  }
  /**
   * <code>repeated .tensorflow.Feature feature = 1;</code>
   */
  public java.util.List<? extends data.FeatureOrBuilder> 
   ...
   * <code>repeated .tensorflow.Feature feature = 1;</code>
   */
  public data.Feature getFeature(int index) {
    return feature_.get(index);
  }
  /**
   * <code>repeated .tensorflow.Feature feature = 1;</code>
   */
  public data.FeatureOrBuilder getFeatureOrBuilder(
      int index) {
    return feature_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof data.FeatureList)) {
      return super.equals(obj);
    }
    data.FeatureList other = (data.FeatureList) obj;
  ...
  public static data.FeatureList parseFrom(
  ...
  public static data.FeatureList parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static data.FeatureList parseFrom(
  ...
  public static data.FeatureList parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static data.FeatureList parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static data.FeatureList parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(data.FeatureList prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using data.FeatureList.newBuilder()
    private Builder() {
    ...
    public data.FeatureList getDefaultInstanceForType() {
      return data.FeatureList.getDefaultInstance();
    }

    public data.FeatureList build() {
      data.FeatureList result = buildPartial();
    ...
    public data.FeatureList buildPartial() {
      data.FeatureList result = new data.FeatureList(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof data.FeatureList) {
        return mergeFrom((data.FeatureList)other);
      } else {
    ...
    public Builder mergeFrom(data.FeatureList other) {
      if (other == data.FeatureList.getDefaultInstance()) return this;
      if (featureBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      data.FeatureList parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (data.FeatureList) e.getUnfinishedMessage();
    ...
    private void ensureFeatureIsMutable() {
      if (!((bitField0_ & 0x00000001) == 0x00000001)) {
        feature_ = new java.util.ArrayList<data.Feature>(feature_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        data.Feature, data.Feature.Builder, data.FeatureOrBuilder> featureBuilder_;
     ...
     */
    public Builder setFeature(
        int index, data.Feature.Builder builderForValue) {
      if (featureBuilder_ == null) {
        ensureFeatureIsMutable();
     ...
     * <code>repeated .tensorflow.Feature feature = 1;</code>
     */
    public Builder addFeature(data.Feature value) {
      if (featureBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addFeature(
        data.Feature.Builder builderForValue) {
      if (featureBuilder_ == null) {
        ensureFeatureIsMutable();
    ...
    public Builder addAllFeature(
        java.lang.Iterable<? extends data.Feature> values) {
      if (featureBuilder_ == null) {
        ensureFeatureIsMutable();
     ...
     * <code>repeated .tensorflow.Feature feature = 1;</code>
     */
    public data.Feature.Builder getFeatureBuilder(
        int index) {
     ...
     * <code>repeated .tensorflow.Feature feature = 1;</code>
     */
    public data.Feature.Builder addFeatureBuilder() {
      return getFeatureFieldBuilder().addBuilder(
          data.Feature.getDefaultInstance());
    }
    /**
     * <code>repeated .tensorflow.Feature feature = 1;</code>
     */
    public data.Feature.Builder addFeatureBuilder(
        int index) {
      return getFeatureFieldBuilder().addBuilder(
          index, data.Feature.getDefaultInstance());
    }
    /**
     * <code>repeated .tensorflow.Feature feature = 1;</code>
     */
    public java.util.List<data.Feature.Builder> 
         getFeatureBuilderList() {
      return getFeatureFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        data.Feature, data.Feature.Builder, data.FeatureOrBuilder> 
        getFeatureFieldBuilder() {
      if (featureBuilder_ == null) {
  ...
  private static final data.FeatureList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new data.FeatureList();
  }

  public static data.FeatureList getDefaultInstance() {
