...
public class NodeFilter_DownsampleTest {
    ...
    public void filterEvenlySpaced() {
        ...
        List<Node> testList = new ArrayList<>(nodeList);
     ...
     */
    private boolean checkForDuplicates(List<Node> nodeList) {
        Set<Node> set = new HashSet<>(nodeList);

        return set.size() < nodeList.size();
    }

    private boolean checkMonotonic(List<Node> nodeList) {
    ...
    private boolean checkEvenSpacing(List<Node> nodeList) {
