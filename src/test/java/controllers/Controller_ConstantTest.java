...
public class Controller_ConstantTest {

    @Test
    public void draw() {
        IController<CommandQWOP, StateQWOP> controller = new Controller_Constant<>(new Action<>(1, CommandQWOP.NONE));
    ...
    @Test
    public void getCopy() {
        IController<CommandQWOP, StateQWOP> controller = new Controller_Constant<>(new Action<>(1, CommandQWOP.NONE)); // Same but with copy.
