...
public class ActionPerturber_SwitchTooSoonTest {
    ...
    public void perturb() {
        ...
        perturbMap.put(1, 1);
        ActionPerturber_SwitchTooSoon<CommandQWOP> actionPerturber1 = new ActionPerturber_SwitchTooSoon<>(perturbMap);
        ...
        Assert.assertEquals(aq.getTotalQueueLengthTimesteps(), queuePerturbed1.getTotalQueueLengthTimesteps());
        Assert.assertEquals(12, actions.get(0).getTimestepsTotal());
        Assert.assertEquals(13, actions.get(1).getTimestepsTotal());
        Assert.assertEquals(9, actions.get(2).getTimestepsTotal());
