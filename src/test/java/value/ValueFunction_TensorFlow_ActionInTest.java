...
//     * First game.action : No keys, 1,2,3
//     * Second game.action : WO, 4,5,6,7
//     * Third game.action : QP, 8,9,10,11
//     * Fourth game.action : [repeats first]
